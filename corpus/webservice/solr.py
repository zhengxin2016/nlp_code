...
class SOLR():
    ...
    def query_solr(self, core_name, question, fields, num):
        query = {
                'q':'question:'+question,
                'fl':fields,
                'rows':num,
    ...
    def query_dialogue_solr(self, core_name, select, fields, num):
        query = {
                'q':select,
                'fl':fields,
                'rows':num,
...
def mongo():
    ...
    for x in db['greeting'].find({},{'question':1}):
...
if __name__ == '__main__':
    ...
    while 1:
        ...
        res = solr.query_solr(core_name, question, ['id', 'question'], 10)
        for x in res.docs:
            print(x['question'])
